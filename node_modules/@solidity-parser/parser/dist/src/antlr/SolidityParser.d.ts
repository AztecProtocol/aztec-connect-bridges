...
export declare class SolidityParser extends Parser {
    ...
    static readonly RULE_customErrorDefinition = 14;
    static readonly RULE_usingForDeclaration = 15;
    static readonly RULE_structDefinition = 16;
    static readonly RULE_modifierDefinition = 17;
    static readonly RULE_modifierInvocation = 18;
    static readonly RULE_functionDefinition = 19;
    static readonly RULE_functionDescriptor = 20;
    static readonly RULE_returnParameters = 21;
    static readonly RULE_modifierList = 22;
    static readonly RULE_eventDefinition = 23;
    static readonly RULE_enumValue = 24;
    static readonly RULE_enumDefinition = 25;
    static readonly RULE_parameterList = 26;
    static readonly RULE_parameter = 27;
    static readonly RULE_eventParameterList = 28;
    static readonly RULE_eventParameter = 29;
    static readonly RULE_functionTypeParameterList = 30;
    static readonly RULE_functionTypeParameter = 31;
    static readonly RULE_variableDeclaration = 32;
    static readonly RULE_typeName = 33;
    static readonly RULE_userDefinedTypeName = 34;
    static readonly RULE_mappingKey = 35;
    static readonly RULE_mapping = 36;
    static readonly RULE_functionTypeName = 37;
    static readonly RULE_storageLocation = 38;
    static readonly RULE_stateMutability = 39;
    static readonly RULE_block = 40;
    static readonly RULE_statement = 41;
    static readonly RULE_expressionStatement = 42;
    static readonly RULE_ifStatement = 43;
    static readonly RULE_tryStatement = 44;
    static readonly RULE_catchClause = 45;
    static readonly RULE_whileStatement = 46;
    static readonly RULE_simpleStatement = 47;
    static readonly RULE_uncheckedStatement = 48;
    static readonly RULE_forStatement = 49;
    static readonly RULE_inlineAssemblyStatement = 50;
    static readonly RULE_doWhileStatement = 51;
    static readonly RULE_continueStatement = 52;
    static readonly RULE_breakStatement = 53;
    static readonly RULE_returnStatement = 54;
    static readonly RULE_throwStatement = 55;
    static readonly RULE_emitStatement = 56;
    static readonly RULE_revertStatement = 57;
    static readonly RULE_variableDeclarationStatement = 58;
    static readonly RULE_variableDeclarationList = 59;
    static readonly RULE_identifierList = 60;
    static readonly RULE_elementaryTypeName = 61;
    static readonly RULE_expression = 62;
    static readonly RULE_primaryExpression = 63;
    static readonly RULE_expressionList = 64;
    static readonly RULE_nameValueList = 65;
    static readonly RULE_nameValue = 66;
    static readonly RULE_functionCallArguments = 67;
    static readonly RULE_functionCall = 68;
    static readonly RULE_assemblyBlock = 69;
    static readonly RULE_assemblyItem = 70;
    static readonly RULE_assemblyExpression = 71;
    static readonly RULE_assemblyMember = 72;
    static readonly RULE_assemblyCall = 73;
    static readonly RULE_assemblyLocalDefinition = 74;
    static readonly RULE_assemblyAssignment = 75;
    static readonly RULE_assemblyIdentifierOrList = 76;
    static readonly RULE_assemblyIdentifierList = 77;
    static readonly RULE_assemblyStackAssignment = 78;
    static readonly RULE_labelDefinition = 79;
    static readonly RULE_assemblySwitch = 80;
    static readonly RULE_assemblyCase = 81;
    static readonly RULE_assemblyFunctionDefinition = 82;
    static readonly RULE_assemblyFunctionReturns = 83;
    static readonly RULE_assemblyFor = 84;
    static readonly RULE_assemblyIf = 85;
    static readonly RULE_assemblyLiteral = 86;
    static readonly RULE_subAssembly = 87;
    static readonly RULE_tupleExpression = 88;
    static readonly RULE_typeNameExpression = 89;
    static readonly RULE_numberLiteral = 90;
    static readonly RULE_identifier = 91;
    static readonly RULE_hexLiteral = 92;
    static readonly RULE_overrideSpecifier = 93;
    static readonly RULE_stringLiteral = 94;

                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            encodedValue = (0, rlp_1.encode)(value);
                                            if (this.DEBUG) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        balance = new ethereumjs_util_1.BN((0, ethereumjs_util_1.toBuffer)(initState[address]));
                        account = ethereumjs_util_1.Account.fromAccountData({ balance: balance });
                        addressBuffer = (0, ethereumjs_util_1.toBuffer)(address);

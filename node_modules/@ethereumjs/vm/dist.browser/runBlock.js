        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (this.DEBUG) {
                        debug('-'.repeat(100));
                        debug("Running block hash=" + block
                            .hash()
                ...
                case 17:
                    ...
                    _a.sent();
                    if (this.DEBUG) {
                        debug("Running block finished hash=" + block
                            .hash()
                            .toString('hex') + " number=" + block.header.number.toNumber() + " hardfork=" + this._common.hardfork());
                    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (!(this._common.consensusType() === common_1.ConsensusType.ProofOfWork)) return [3 /*break*/, 6];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, receiptTrie.put((0, rlp_1.encode)(txIdx), encodedReceipt)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
...
function encodeReceipt(tx, receipt) {
    var encoded = (0, rlp_1.encode)(Object.values(receipt));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    receiptLog = "Generate tx receipt transactionType=" + tx.type + " gasUsed=" + blockGasUsed.toString() + " bitvector=" + (0, opcodes_1.short)(abstractTxReceipt.bitvector) + " (" + abstractTxReceipt.bitvector.length + " bytes) logs=" + abstractTxReceipt.logs.length;
                ...
                case 2:
                    ...
                    _b.label = 3;
                case 3:
                    encodedReceipt = (0, rlp_1.encode)(Object.values(txReceipt));
                    return [3 /*break*/, 5];
                case 4:
                    // EIP2930 Transaction
                    txReceipt = __assign({ status: txRes.execResult.exceptionError ? 0 : 1 }, abstractTxReceipt);
                    encodedReceipt = Buffer.concat([(0, ethereumjs_util_1.intToBuffer)(tx.type), (0, rlp_1.encode)(Object.values(txReceipt))]);
                    _b.label = 5;
                case 5: return [2 /*return*/, {
                        txReceipt: txReceipt,
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, trie.put((0, rlp_1.encode)(i), tx.serialize())];
                case 3:
                    _e.sent();
                    _e.label = 4;
                case 4:

...
class EVM {
    ...
    async executeMessage(message) {
        ...
        if (this._vm.DEBUG) {
            debug(`Received message results gasUsed=${result.gasUsed} execResult: [ gasUsed=${result.gasUsed} exceptionError=${result.execResult.exceptionError ? result.execResult.exceptionError.toString() : ''} returnValue=${(0, util_1.short)(result.execResult.returnValue)} gasRefund=${(_a = result.execResult.gasRefund) === null || _a === void 0 ? void 0 : _a.toString()} ]`);
        }

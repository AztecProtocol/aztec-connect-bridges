...
var DBManager = /** @class */ (function () {
    ...
    DBManager.prototype.getBlock = function (blockId) {
        return __awaiter(this, void 0, void 0, function () {
            var number, hash, header, body, error_4, blockData, parentTd, opts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 10:
                        ...
                        if (!!number.eqn(0)) return [3 /*break*/, 12];
                        return [4 /*yield*/, this.getTotalDifficulty(header.parentHash, number.subn(1))];
                    case 11:
                        parentTd = _a.sent();
                        _a.label = 12;
                    case 12:
                        opts = { common: this._common, hardforkByTD: parentTd };
    ...
    DBManager.prototype.getHeader = function (blockHash, blockNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var encodedHeader, parentTd, parentHash, opts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!!blockNumber.eqn(0)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.numberToHash(blockNumber.subn(1))];
                    case 2:
                        parentHash = _a.sent();

...
/// uint256(MAX_TICK) where MAX_TICK is an int24
/// certain kinds of explicit type conversions have been disallowed in solidity versions 0.8.x
///the fix for this is to change line 34 from uint256(MAX_TICK) to uint256(uint24(MAX_TICK))
...
library TickMath {
    ...
    function getSqrtRatioAtTick(int24 tick) internal pure returns (uint160 sqrtPriceX96) {
        ...
        require(absTick <= uint256(uint24(MAX_TICK)), "T"); //this line has been modified from the original Uniswap V3 library

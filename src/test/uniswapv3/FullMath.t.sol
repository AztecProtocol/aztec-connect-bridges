...
contract MathTest is Test {
    ...
    function testShouldCorrectlyCalculateMulDivWithOverflow4() public {
        ...
        uint256 actual = FullMath.mulDiv(
            74546461817018951432445240571000390099089545977406,
            979125657354410079800799730287044976961723621754204857696697,
            denominator
        );
        assertEq(actual, expected);
    }
    ...
    function testShouldCorrectlyCalculateMulDivRoundingUpWithOverflow() public {
        ...
        uint256 denominator = 7519878498690977247166484629857052324372;
        uint256 actual = FullMath.mulDivRoundingUp(
            74546461817018951432445240571000390099089545977406,
            979125657354410079800799730287044976961723621754204857696697,
            denominator
        );

...
contract LidoTest is BridgeTestBase {
    ...
    function validateWrap(uint256 _depositAmount) public {
        ...
        uint256 bridgeCallData =
            ROLLUP_ENCODER.defiInteractionL2(idIn, ethAsset, emptyAsset, wstETHAsset, emptyAsset, 0, _depositAmount);
    ...
    function validateUnwrap(uint256 _depositAmount) public {
        ...
        uint256 bridgeCallData =
            ROLLUP_ENCODER.defiInteractionL2(idOut, wstETHAsset, emptyAsset, ethAsset, emptyAsset, 0, _depositAmount);

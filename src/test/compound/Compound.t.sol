...
contract CompoundTest is DSTest {
    ...
    function testCompoundBridgeDAI() public {
        ...
        assertGt(rollupcDai, 0, "cDAI received is zero");
    }
    ...
    function testCompoundBridgeTUSD() public {
        ...
        assertGt(rollupcTUSD, 0, "cTUSD received is zero");
    }
    ...
    function testCompoundBridgeUSDC(uint256 depositAmount) public {
        ...
        assertGt(rollupcUSDC, 0, "cUSDC received is zero");
    }
    ...
    function testCompoundBridgeUSDP(uint256 depositAmount) public {
        ...
        assertGt(rollupcUSDP, 0, "cUSDP received is zero");
    }
    ...
    function testCompoundBridgeUSDT(uint256 depositAmount) public {
        ...
        assertGt(rollupcUSDT, 0, "cUSDT received is zero");
    }
    ...
    function testCompoundBridgeAAVE() public {
        ...
        assertGt(rollupcAAVE, 0, "cAAVE received is zero");
    }
    ...
    function testCompoundBridgeBAT() public {
        ...
        assertGt(rollupcBAT, 0, "cBAT received is zero");
    }
    ...
    function testCompoundBridgeCOMP() public {
        ...
        assertGt(rollupcCOMP, 0, "cCOMP received is zero");
    }
    ...
    function testCompoundBridgeLINK(uint256 depositAmount) public {
        ...
        assertGt(rollupcLINK, 0, "cLINK received is zero");
    }
    ...
    function testCompoundBridgeMKR() public {
        ...
        assertGt(rollupcMKR, 0, "cMKR received is zero");
    }
    ...
    function testCompoundBridgeSUSHI(uint256 depositAmount) public {
        ...
        assertGt(rollupcSUSHI, 0, "cSUSHI received is zero");
    }
    ...
    function testCompoundBridgeUNI() public {
        ...
        assertGt(rollupcUNI, 0, "cUNI received is zero");
    ...
    function testCompoundBridgeWBTC2() public {
        ...
        assertGt(rollupcWBTC2, 0, "cWBTC2 received is zero");
    }
    ...
    function testCompoundBridgeYFI(uint256 depositAmount) public {
        ...
        assertGt(rollupcYFI, 0, "cYFI received is zero");
    }
    ...
    function testCompoundBridgeZRX(uint256 depositAmount) public {
        ...
        assertGt(rollupcZRX, 0, "cZRX received is zero");
    }
    ...
    function _setTokenBalance(
        ...
        uint256 slot;
        if (token == AAVEaddress || token == WBTCaddress) slot = 0;
        else if (token == SUSHIaddress || token == YFIaddress) slot = 0;
        else if (token == BATaddress || token == MKRaddress) slot = 1;
        else if (token == LINKaddress || token == COMPaddress) slot = 1;
        else if (token == USDPaddress) slot = 1;
        else if (token == UNIaddress) slot = 4;
        ...
        else if (token == TUSDaddress) slot = 14;
        else if (token == cETHaddress || token == cZRXaddress) slot = 15;
        else slot = 2; // May vary depending on token

...
import {UniswapV2Bridge} from "./../../bridges/uniswap/UniswapV2Bridge.sol";
...
contract UniswapTest is DSTest {
    ...
    function setUp() public {
        ...
        uniswapV2Bridge = new UniswapV2Bridge(
    ...
    function testUniswapV2Bridge() public {
       uint256 depositAmount = 15000;
        ...
        // 1. expect the rollup to transfer DAI to the bridge
        // 2. expect the bridge to call Uniswap

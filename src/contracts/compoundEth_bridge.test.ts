...
import { deployCEth } from '../deploy/deploy_compound';
import abi from '../artifacts/contracts/CompoundEthBridge.sol/CompoundEthBridge.json';
...
describe('defi bridge', function () {
  ...
  beforeAll(async () => {
    ...
    const compound = await deployCEth(signer);

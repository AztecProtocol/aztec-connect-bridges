...
export class CompoundBridgeData implements BridgeDataFieldGetters {
    ...
    private constructor(
        private comptrollerContract: IComptroller,
      ) {}
    ...
    static create(provider: JsonRpcProvider) {
        ...
        const comptrollerContract = IComptroller__factory.connect("0x3d9819210A31b4961b30EF54bE2aeD79B9c9Cd3B", ethersProvider);

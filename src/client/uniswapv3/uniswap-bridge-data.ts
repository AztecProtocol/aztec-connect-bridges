...
export class SyncUniswapBridgeData implements BridgeData {
  ...
  */
  ...
  async getExpectedOutput(
    ...
    let ABI = ["function convert( tuple(uint256 id,address erc20Address,uint8 assetType) inputAssetA, tuple(uint256 id,address erc20Address,uint8 assetType) inputAssetB,tuple(uint256 id,address erc20Address,uint8 assetType) outputAssetA,tuple(uint256 id,address erc20Address,uint8 assetType) outputAssetB,uint256 inputValue,uint256 interactionNonce,uint64 auxData)"];

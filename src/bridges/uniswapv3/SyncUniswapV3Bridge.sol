    ...
    */
        ...
        )
    {
        ...
        if (
            ...
            _checkForType(inputAssetA) != address(0) &&
            ...
            //state changes
            SyncMintFundingMap[interactionNonce] = MintFunding({token: input_address, amount: inputValue});
        ...
        //1 virtual 1 real (refund)
            ...
            _checkForType(inputAssetA) != address(0) &&
            outputAssetA.assetType == AztecTypes.AztecAssetType.VIRTUAL &&
            _checkForType(outputAssetB) != address(0)
        ) {
            //minting LP position
            ...
            require(
                input_address == refund_address || refund_address == SyncMintFundingMap[inputAssetB.id].token,
                "INVALID_REFUND"
            );
        ...
        //1 real 1 real
            ...
            _checkForType(outputAssetA) != address(0) &&
            inputAssetB.assetType == AztecTypes.AztecAssetType.NOT_USED &&

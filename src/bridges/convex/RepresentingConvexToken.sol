...
/**
 * @notice Share of the staked assets held by the bridge.
 * @dev ERC20 token deployed for a specific pool to represent pool specific Convex LP token.
 ...
 * @dev RCT (share) : Curve LP tokens (asset) = 1e10 : 1.

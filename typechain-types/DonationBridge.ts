...
export type ListedDoneeEvent = TypedEvent<
  [string, BigNumber],
  ListedDoneeEventObject
>;
...
export interface DonationBridge extends BaseContract {
  ...
  filters: {
    "ListedDonee(address,uint64)"(
      donee?: null,
      index?: null
    ): ListedDoneeEventFilter;

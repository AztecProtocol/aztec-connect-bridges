...
export interface TroveBridgeTestBaseInterface extends utils.Interface {
  functions: {
...
export interface TroveBridgeTestBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TroveBridgeTestBaseInterface;

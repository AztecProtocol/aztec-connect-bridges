...
export interface ExampleTestInterface extends utils.Interface {
  contractName: "ExampleTest";
  functions: {
    "IS_TEST()": FunctionFragment;
    "failed()": FunctionFragment;
    "setUp()": FunctionFragment;
    "testExampleBridge()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testExampleBridge",
    values?: undefined
  ): string;
...
export interface ExampleTest extends BaseContract {
  contractName: "ExampleTest";
  ...
  callStatic: {
    ...
    testExampleBridge(overrides?: CallOverrides): Promise<void>;
  };

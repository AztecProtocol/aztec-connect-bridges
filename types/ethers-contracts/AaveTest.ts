...
export interface AaveTestInterface extends utils.Interface {
  contractName: "AaveTest";
  functions: {
    "IS_TEST()": FunctionFragment;
    "_enterWithDai(uint256)": FunctionFragment;
    "_exitWithDai(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_enterWithDai",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "_exitWithDai",
    values: [BigNumberish]
  ): string;
...
export interface AaveTest extends BaseContract {
  contractName: "AaveTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveTestInterface;
